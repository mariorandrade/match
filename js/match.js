...
var MatchMe = (function ($, _) {
    ...
    * */
    ...
    var setMatched = function () {
        ...
        if(isCompleted()) {
            alert('todas as combinações acertadas');
        }
